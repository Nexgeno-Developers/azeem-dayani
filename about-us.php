...
<html lang="en">
  ...
  <body class="scroll-container" data-scroll-container>
    ...
    <main id="about_us_page">
      <section class="about_azeem_dayani bg_green icon-container">
        <div
          class="music_director_composer_main_div col-md-12 row zip_zap_bg_img_container"
        >
          <img
          ...
          <div class="col-md-7">
            <img
              src="images/about-us/Main-Image_2.jpg"
              alt="azeem big photo"
          ...
          <div class="col-md-4 about_main_div animate-about-first-section">
            <div class="col-md-12 about">
              <div class="position-relative">
                <!-- <img class="image_heading azeem_heading" src="images/about-us/Top_Logo.png"> -->
                <h4 class="about_main_name footer_logo_text">azeem dayani</h4>
              </div>

              <div class="about_content">
                <h5
                  class="animated-heading-about music_director_composer_heading pb-md-2"
                >
        ...
        <div class="azeem_stadium_img_div">
          <img
            class="reveal-img-diagonal azeem_stadium_img"
            src="images/about-us/azeem_goggle_img.png"
          />
        </div>
        ...
        <div class="cutting_headphone_div col-md-8">
          <img
            class="scaleup-element cutting_headphone"
            src="images/about-us/Headphones.png"
          />
        </div>
        <div class="text-white" id="bars4"></div>
      </section>
      <section
        class="vision_main_section icon-container zip_zap_bg_img_container"
      >
        <div class="film_music_zig_zag_img_div">
          <img
            class="zig-zag-img film_music_zig_zag_img"
            src="images/Homepage/Object_2.png"
          />
        </div>
        ...
        <div
          class="row vision_main_div align-items-center justify-content-center"
        >
          ...
          <div class="col-md-9">
            <img
              class="scaleup-element vision_main_image"
              src="images/about-us/Image_2.jpg"
            />
          ...
          <!-- <div class="cutting_headphone_div col-md-7">
                    <img class="cutting_headphone" src="images/about-us/Music_5.png">
                </div>         -->
          <div class="slidercircle">
            <div class="circle-one"></div>
    ...
    <footer class="bg_blue footer pt_6">
      <div class="">
