    ...
    <main id="works_page">
      <section class="animate-work-first-section works_section film_section">
        <div class="works_headphone_heading">
          ...
          <img
            class="img-scale-work headphone_heading"
            src="images/Work/Headphones.png"
          />
          <div class="text-white" id="bars5"></div>
        </div>
        <p
          class="animated-para-work section_description text-center col-md-9 mx-auto pt-md-4"
        >
        ...
        <p
          class="animated-para-work section_description text-center col-md-9 mx-auto pt-md-2"
        >
        ...
        <div class="row film_row">
          <div class="col-md-4 mb-4">
            <a href="film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_1.png"
                  class="card-img-top"
                  alt="Kapoor &amp; Sons"
                />
          ...
          <div class="col-md-4 mb-4">
            <a href="film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_2.png"
                  class="card-img-top"
                  alt="Baar Baar Dekho (2016)"
                />
                <div class="text-overflow card-body">
          ...
          <div class="col-md-4 mb-4">
            <a href="film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_4.png"
                  class="card-img-top"
                  alt="Badrinath ki Dulhania (2017)"
                />
                <div class="text-overflow card-body">
          ...
          <div class="col-md-4 mb-4">
            <a href="film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_5.png"
                  class="card-img-top"
                  alt="Bareilly Ki Barfi (2017)"
                />
                <div class="text-overflow card-body">
          ...
          <div class="col-md-4 mb-4">
            <a href="film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_13.png"
                  class="card-img-top"
                  alt="Jugjugg Jeeyo (2022)"
                />
                <div class="text-overflow card-body">
          ...
          <div class="col-md-4 mb-4">
            <a href="film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_16.png"
                  class="card-img-top"
                  alt="Mr. & Mrs. Mahi (2024)"
                />
                <div class="text-overflow card-body">
      ...
      <section class="works_section non_film_section">
        ...
        <div class="row non_film_row">
          <div class="col-md-4 mb-4">
            <a href="non-film-details.php" class="card-link">
              <div class="card">
                <img
                  src="images/Work/Image_18.png"
                  class="card-img-top"
                  alt="Vaaste (2019)"
                />
                <div class="text-overflow card-body">
